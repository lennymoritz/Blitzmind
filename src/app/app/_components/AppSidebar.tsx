 ...
 *
 * Layout: fixed left, full height, ~240px wide. Logo + 8 destinations +
 * live status footer (HRV + connection state). Active route highlighted
 * with the app accent color.
 *
 * Motion: when the active route changes, the accent pill (background +
 * left bar) slides from the old item to the new one using Motion's
 * shared layout animation. Single LayoutGroup wraps both groups of nav
 * items so the slide also works when navigating across the "system"
 * divider.
 *
 * Design language: denser than the marketing site. Smaller type. No
 * decorative ECG lines or serif headers — utilitarian.
 */
...
const navItems = [
  ...
  // Divider — adaptive control sits in its own group
...
export function AppSidebar() {
  ...
  return (
    <aside
      className="fixed left-0 top-0 bottom-0 w-[240px] border-r flex flex-col"
      style={{
...
function NavLink({
  ...
  return (
    ...
    >
      ...
      {/* Shared layout accent bar — slides with the pill */}
      {active && (
        <motion.span
...
function HomeIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 16 16" fill="none" aria-hidden>
      <path d="M2 7 L8 2 L14 7 V13 H10 V9 H6 V13 H2 Z" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round" />
    </svg>
  );
}
function LiveIcon() {
...
function SessionsIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 16 16" fill="none" aria-hidden>
      ...
      <rect x="2" y="7.5" width="12" height="3" stroke="currentColor" strokeWidth="1.2" />
      <rect x="2" y="12" width="12" height="2" stroke="currentColor" strokeWidth="1.2" />
    </svg>
  );
}
function InsightsIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 16 16" fill="none" aria-hidden>
      <path d="M2 13 L6 8 L9 11 L14 4" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round" strokeLinecap="round" />
...
function AdaptIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 16 16" fill="none" aria-hidden>
      ...
      <line x1="4" y1="6" x2="4" y2="10" stroke="currentColor" strokeWidth="1.2" />
      <line x1="12" y1="6" x2="12" y2="10" stroke="currentColor" strokeWidth="1.2" />
    </svg>
  );
}
function LibraryIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 16 16" fill="none" aria-hidden>
      <rect x="2" y="2" width="5" height="6" stroke="currentColor" strokeWidth="1.2" />
      <rect x="9" y="2" width="5" height="6" stroke="currentColor" strokeWidth="1.2" />
...
function SettingsIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 16 16" fill="none" aria-hidden>
      ...
      <path d="M8 1 L8 3 M8 13 L8 15 M1 8 L3 8 M13 8 L15 8 M3 3 L4.5 4.5 M11.5 11.5 L13 13 M3 13 L4.5 11.5 M11.5 4.5 L13 3" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
    </svg>
  );
}
